...
//==================== from
from 'from' 
	= t_from __ s:scope o:(_ t_with __ o:options { return o })? {
  		s.options = o
  		return s
    }
...
//==================== filter, match
filter 'filter'
	= t_filter __ c:conditions o:(_ t_with __ o:options { return o })? { 
			return {
				filters : c,
				options : o
			}
...
match 'match' 
	= t_match __ c:conditions o:(_ t_with __ o:options { return o })? { 
			return {
				matches : c,
				options : o
			}
...
//==================== sort
sort 'sort'
	= t_sort __ s:orders o:(_ t_with __ o:options { return o })? { 
			return {
				sorts   : s,
				options : o
			}
